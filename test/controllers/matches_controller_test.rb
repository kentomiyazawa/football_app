...
class MatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create match" do
    assert_difference('Match.count') do
      post matches_url, params: { match: { name: @match.name, start_time: @match.start_time } }
    end
  ...
  test "should update match" do
    patch match_url(@match), params: { match: { name: @match.name, start_time: @match.start_time } }
